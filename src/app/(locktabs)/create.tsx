      ...
      >
        ...
        >
          <View style={styles.importIconBox}>
            <Ionicons name="cloud-upload" size={36} color="#0d3793" />
          </View>
            ...
            <View style={styles.tagList}>
              {tags.map((tag) => (
                ...
                >
                  ...
                  <Ionicons name="close" size={14} color="#020f2c" />
                </Pressable>
              ))}
            </View>
          )}
